...
log_file = r'E:\Machine_Learning\Project\LiSA\run\lisa_amazon_photo.log'
...
if __name__ == "__main__":
    ...
    dataset_cls = Amazon(dataset_dir, 'Photo', transform=T.NormalizeFeatures())
    ...
    dataset_link = Amazon(dataset_dir, 'Photo', transform=transform)
