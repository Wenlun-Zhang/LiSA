...
log_file = r'E:\Machine_Learning\Project\LiSA\run\lisa_cora.log'
...
if __name__ == "__main__":
    ...
    dataset_cls = Planetoid(dataset_dir, 'Cora', transform=T.NormalizeFeatures())
    ...
    dataset_link = Planetoid(dataset_dir, 'Cora', transform=transform)
