...
log_file = r'E:\Machine_Learning\Project\LiSA\run\lisa_citeseer.log'
...
if __name__ == "__main__":
    ...
    dataset_cls = Planetoid(dataset_dir, 'CiteSeer', transform=T.NormalizeFeatures())
    ...
    dataset_link = Planetoid(dataset_dir, 'CiteSeer', transform=transform)
